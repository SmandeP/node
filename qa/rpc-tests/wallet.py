...
#   c) node1 mines 32 blocks, so now node 0 has 60001crn, node 1 has 4250crn, node2 has none.
#   d) node0 sends 601 crn to node2, in two transactions (301 crn, then 300 crn).
