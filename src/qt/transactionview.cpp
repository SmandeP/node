 ...
 */
    ...
    typeWidget->addItem(tr("Received Crn from zCrn"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCrn"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zCrn));
