Contributing to Chronos Core
============================

The Chronos Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Chronos Core project, and is not to be
confused with overall Chronos Network Protocol consensus changes.

Whether a pull request is merged into Chronos Core rests with the project merge
...
Patches that change Chronos consensus rules are considerably more involved than
...
Where a patch set proposes to change the Chronos consensus, it must have been
...
The project leader is the release manager for each Chronos Core release.
