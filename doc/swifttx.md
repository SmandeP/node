...
This mechanism has been integrated into Bitcore-Node-Chronos which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Chronos-Project/insight-api-chronos#web-socket-api](https://github.com/Chronos-Project/insight-api-chronos#web-socket-api) 
* API: [https://github.com/Chronos-Project/insight-api-chronos#swifttx-transactions](https://github.com/Chronos-Project/insight-api-chronos#swifttx-transactions) 
