...
In order to support loading of multiple wallets in chronos-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is chronos.cpp.
...
Changes to chronos.cpp
----------------------
chronos.cpp is the entry point into chronos-qt, and as such, will require some minor modifications to provide hooks for
